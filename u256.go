...
// PaddedBytes encodes a Uint256 as a 0-padded byte slice. The length
...
// The n must be <= 255.
func (z *Uint256) isBitSet(n uint) bool {
...
func udivrem(quot, u []uint64, d, rem *Uint256) {
	var dLen int
	for i := len(d) - 1; i >= 0; i-- {
		if d[i] != 0 {
			dLen = i + 1
...
func (z *Uint256) Div(x, y *Uint256) *Uint256 {
	...
	// Shortcut some cases
	if x.Is64() {
		return z.Set64(x.Uint64() / y.Uint64())
	}
...
func (z *Uint256) DivMod(x, y, m *Uint256) (*Uint256, *Uint256) {
	...
	if x.Is64() {
		...
		return z.Set64(x0 / y0), m.Set64(x0 % y0)
	}
...
func (z *Uint256) SDiv(n, d *Uint256) *Uint256 {
	...
	if d.Sign() < 0 {
		// neg / neg
		z.Div(new(Uint256).Neg(n), new(Uint256).Neg(d))
		return z
	}
	// neg / pos
	z.Div(new(Uint256).Neg(n), d)
	return z.Neg(z)
}
...
func (z *Uint256) lsh64(x *Uint256) *Uint256 {
	z[3], z[2], z[1], z[0] = x[2], x[1], x[0], 0
	return z
}
func (z *Uint256) lsh128(x *Uint256) *Uint256 {
	z[3], z[2], z[1], z[0] = x[1], x[0], 0, 0
	return z
}
func (z *Uint256) lsh192(x *Uint256) *Uint256 {
	z[3], z[2], z[1], z[0] = x[0], 0, 0, 0
	return z
}
func (z *Uint256) rsh64(x *Uint256) *Uint256 {
	z[3], z[2], z[1], z[0] = 0, x[3], x[2], x[1]
	return z
}
func (z *Uint256) rsh128(x *Uint256) *Uint256 {
	z[3], z[2], z[1], z[0] = 0, 0, x[3], x[2]
	return z
}
func (z *Uint256) rsh192(x *Uint256) *Uint256 {
	z[3], z[2], z[1], z[0] = 0, 0, 0, x[3]
	return z
}
func (z *Uint256) srsh64(x *Uint256) *Uint256 {
	z[3], z[2], z[1], z[0] = math.MaxUint64, x[3], x[2], x[1]
	return z
}
func (z *Uint256) srsh128(x *Uint256) *Uint256 {
	z[3], z[2], z[1], z[0] = math.MaxUint64, math.MaxUint64, x[3], x[2]
	return z
}
func (z *Uint256) srsh192(x *Uint256) *Uint256 {
...
func (z *Uint256) Sqrt(x *Uint256) *Uint256 {
	...
	z1 := NewUint256From64(1)
	z2 := NewUint256From64(0)
...
func (z *Uint256) Log10() uint {
	...
	// https://graphics.stanford.edu/~seander/bithacks.html#Uint256egerLog10
	//
...
func Reciprocal(m *Uint256) (mu [5]uint64) {
	...
	var (
		y  Uint256 // left-aligned copy of m
...
func (z *Uint256) reduce4(x *[8]uint64, m *Uint256, mu *[5]uint64) *Uint256 {
